...
public class MockResultSet implements ResultSet {
    ...
    private final AtomicInteger integerCounter = new AtomicInteger(0);
    private final AtomicInteger doubleCounter = new AtomicInteger(0);
    private final AtomicInteger booleanCounter = new AtomicInteger(0);
    private final AtomicInteger timestampCounter = new AtomicInteger(0);
